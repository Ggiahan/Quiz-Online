<%-- 
    ...
    Created on : 28-Jan-2021, 13:13:43
    Author     : DELL
--%>
    ...
    <body>
        ...
        <div class="contact-box">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="" action="CreateQuestionAction">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group"> 
                                        ...
                                        <textarea name="txtQuestion" class="form-control" id="message" placeholder="Question" rows="4" 
                                                  data-error="Write your message" required>${param.txtQuestion}</textarea>
                                        <div class="help-block with-errors"></div>
                                     </div>                              
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group"> 
                                        <textarea name="txtAnswerA" class="form-control" id="message" placeholder="Answer A" data-error="Write your message" required>${param.txtAnswerA}</textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group"> 
                                        ...
                                        <textarea  name="txtAnswerB" class="form-control" id="message" placeholder="Answer B" data-error="Write your message" required>${param.txtAnswerB}</textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group"> 
                                        <textarea  name="txtAnswerC" class="form-control" id="message" placeholder="Answer C" data-error="Write your message" required>${param.txtAnswerC}</textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group"> 
                                        <textarea name="txtAnswerD" class="form-control" id="message" placeholder="Answer D" data-error="Write your message" required>${param.txtAnswerD}</textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
