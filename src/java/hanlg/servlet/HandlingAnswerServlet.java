 ...
 * @author DELL
 */
public class HandlingAnswerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String btAction = request.getParameter("btAction");
        ...
        try  {
          ...
          if(btAction.equalsIgnoreCase("Previous")) count= currentquestion-1;
          else if(btAction.equalsIgnoreCase("Next")) count= currentquestion+1;
             if(Answer!=null){
